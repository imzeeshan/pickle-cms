        ...
        <div class="container-xl">
            <div class="row row-cards">
                <div class="col-12">                 
                        ...
                        <form class="card" role="form" method="POST" action="{{ route('posts.update',$post->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="card-header">
                                <h4 class="card-title">Blog Posts Manager: Edit Blog Post</h4>
                            </div>
                                    ...
                                    <div class="col-lg-8">                                  
                                        ...
                                        <div class="mb-3">
                                            <div class="form-group col-8">
                                                ...
                                                <textarea class="form-control summernote" id='summernote' name="description">{{$post->description}}</textarea>
                                            </div>
                                        </div>
